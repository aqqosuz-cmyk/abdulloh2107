...
# Kanaldagi pin (mahkamlangan) qilingan reklama postining ID raqamini avtomatik olish
...
# Qo'llanma kanalidagi pin (mahkamlangan) qilingan postning ID raqamini avtomatik olish
...
async def help_instruction(message: Message, bot: Bot):
  ...
  if help_msg_id > 0:
    try:
      # Kanal nomi ko'rinmaydigan qilib pin qilingan postni copy qilamiz
      await bot.copy_message(
...
# Barcha matnli xabarlarni tekshirib, kodni qidiradi
